...
import { sampleWithRequiredData } from '../character.test-samples';
...
describe('Character Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.characters?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });
