...
/**
 * REST controller for managing {@link lucascantao.charitem.domain.Item}.
 */
@RestController
...
public class ItemResource {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Item> updateItem(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Item item)
    ...
    public ResponseEntity<Item> partialUpdateItem(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Item item)
        throws URISyntaxException {
